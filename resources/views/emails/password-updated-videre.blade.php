...
<head>
    <meta charset="UTF-8">
    <title>Contraseña actualizada – Holos</title>
</head>
...
<body style="font-family: Arial, sans-serif; background:#f5f5f5; padding:20px;">
    <div style="max-width:600px; margin:auto; background:#ffffff; padding:30px; border-radius:6px;">
        ...
        <div style="text-align:center; margin-bottom:20px;">
            <img src="{{ asset('assets/img/HolosLogo.png') }}" alt="Holos" style="max-width:180px;">
        </div>
        ...
        <p>
            Te confirmamos que la contraseña de tu cuenta en <b>Holos</b>
